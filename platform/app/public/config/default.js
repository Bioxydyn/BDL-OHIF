        ...
        $set: [
          {
            ...
            contentF: ({ instance, viewport }) => {
              ...
              if (instance && instance.InstanceNumber !== undefined) {
                const { imageIndex, numberOfImages } = viewport || {};
                const currentIndex =
                  imageIndex !== undefined ? imageIndex + 1 : instance.InstanceNumber;
                const total = numberOfImages || 'N/A';
                content = `I: ${instance.InstanceNumber} (${currentIndex}/${total})`;
              }
